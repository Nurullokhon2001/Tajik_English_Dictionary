package com.example.alifboitj.repository.sqllite
...
/**
 * Created by ABDUAHAD FAIZULLOEV on 04-02-2021.
 */
open class MySQLiteOpenHelper(private val mContext: Context) : SQLiteOpenHelper(mContext, DB_NAME, null, DB_VERSION) {
    ...
    companion object {
        ...
        private const val DB_NAME = "tjen.db"
