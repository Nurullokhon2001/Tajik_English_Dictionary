...
class TajikTopic : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_tajik_topic, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.fetchDictionaries().observe(viewLifecycleOwner, Observer {
            adapter = TajikDictionaryAdapter(it, this@TajikTopic)
    ...
    override fun onClick(itemView: View?) {
        if(itemView!=null){
            ...
            requireActivity().supportFragmentManager.beginTransaction().replace(R.id.fragment,TajikFragment.newInstance(position)).addToBackStack(TajikFragment.javaClass.simpleName).commit()
